        ...
        <div className="container">
            <div className="row align-items-center d-flex justify-content-center bg-pearl-light p-4 mt-8">
                <div className="col-md-7 ">
                    <h2>Cactus Tree</h2>
                    <p className="mt-4 cactus_subTitle">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Totam molestiae sunt cumque, et iusto magni eaque corrupti fugiat corporis aut recusandae iste quam magnam rerum eligendi saepe aperiam rem quaerat dolore? Quibusdam harum in quod, vero quo nobis veniam iste.</p>
